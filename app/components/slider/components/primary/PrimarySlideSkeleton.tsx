    ...
    <div className="relative animate-pulse">
      <div className=" w-full h-110 md:h-100 lg:h-140 bg-gray-200">
        <div className="w-full h-full bg-gray-200">
          <div className="flex justify-center items-center w-full h-full relative bg-gray-200">
            <div className="border-2 border-slate-400 w-[50%] h-[50%] bg-gray-200 absolute bottom-12 left-20 rounded-lg p-2 lg:bottom-25 md:w-50 lg:w-120 flex flex-col justify-center dark:bg-black/50">
              ...
              <a
                className="bg-gray-400 w-[50%] h-8 lg:w-45 p-1 md:p-2 mt-8 md:mt-6 md:mb-2 lg:mt-12 lg:mb-6 rounded-4xl transition duration-300 ease-in-out hover:bg-slate-900 flex justify-center items-center "
                href={`#`}
              >
